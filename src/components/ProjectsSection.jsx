...
const projects = [
  {
    ...
    description:
      "A 3D interactive Rubik’s Cube built with C++ and OpenGL that can solve any valid scrambled state using the Breadth-First Search (BFS) algorithm. Features real-time cube visualization, user controls, and smooth solving animations. Showcases my skills in graphics programming, algorithmic thinking, and low-level system design.",
    image: "/projects/Rubik.jpg",
    tags: ["OpenGL", "C++", "glut"],
    demoUrl: "#",
    githubUrl: "https://github.com/Sparsh12321/Rubik-s-Cube-Solver-OpenGL",
    demoStatus: "offline",
  },
  {
    id: 2,
    ...
    image: "/projects/WildOasisAdmin.png",
    tags: [
      "React",
      "Styled-Components",
      "React-Query",
    ...
    demoUrl: "https://wild-oasis-pzz9.vercel.app/",
    githubUrl: "https://github.com/Sparsh12321/Wild_Oasis",
    demoStatus: "online",
  },
  {
    id: 3,
    title: "TextBrief",
    description:
      "TextBrief is a smart Chrome extension that lets you summarize any webpage in just a click using Google's Gemini AI. ",
    image: "/projects/SummSnap.png",
    tags: ["JavaScript", "Chrome Extension", "Gemini AI"],
    demoUrl:
      "https://chrome.google.com/webstore/detail/ss",
    githubUrl: "https://github.com/Sparsh12321/TextBrief",
    demoStatus: "online",
  },
  {
    id: 4,
    title: "Roomzy",
    description:
      "Roomzy is a full-stack web application that allows users to list, explore, and book rental properties or hotels. Built with a focus on performance, user experience, and modern web standards,",
    image: "/projects/Roomzy.png",
    tags: ["Node.js", "Express.js", "MongoDB", "Mongoose", "REST-API", "Pug"],
    demoUrl: "https://roomzy-1.onrender.com",
    githubUrl: "https://github.com/Sparsh12321/Roomzy",
    demoStatus: "online",
  },
  {
    id: 5,
    ...
    image: "/projects/WildOasisCustomer.png",
    tags: ["Next.js", "Tailwind CSS", "Supabase", "NextAuth-Google"],
    demoUrl: "https://wild-oasis-demo-one.vercel.app",
    githubUrl: "https://github.com/Sparsh12321/Wild_Oasis-Customer",
    demoStatus: "online",
  },
  {
    id: 6,
    title: "PocketPulse",
    description:
      "PocketPulse is a smart expense tracker that analyzes your spending patterns using AI, extracts data from receipts via OCR, and provides real-time insights through interactive charts and dashboards. Built with modern full-stack technologies and designed for personal financial clarity"

,
    image: "/projects/PocketPulse.png",
    tags: ["Next.js", "ReactJs", "Supabase", "Clerk.js", "Recharts", "TailwindCss"],
    demoUrl:
      "https://pocket-pulse-liart.vercel.app",
    githubUrl: "https://github.com/Sparsh12321/PocketPulse",
    demoStatus: "online",
  },
  {
    id: 7,
    title: "WorldWise",
    description:
      "A clean, responsive web app to track and document all the places you've visited worldwide. ",
    image: "/projects/WorldWise.png",
    tags: ["ReactJs", "leaflet.js"],
    demoUrl: "https://wordl-wise.vercel.app",
    githubUrl: "https://github.com/Sparsh12321/WorldWise",
    demoStatus: "online",
  },
  {
    id: 8,
    ...
    demoUrl: "https://fast-react-pizza-xi-sand.vercel.app",
    githubUrl: "https://github.com/Sparsh12321/Fast-Pizza",
    demoStatus: "online",
  },
  {
    id: 9,
    title: "AR-Wonders",
    description:
      "AR Wonders is an Augmented Reality application developed in Unity using Vuforia. The project showcases a hologram-like effect where Earth spawns with rotating 3D models of the 7 Wonders of the World.",
    image: "/projects/AR.jpg",
    tags: ["Unity", "C#", "Vuforia"],
    demoUrl:
      "#",
    githubUrl: "https://github.com/Sparsh12321/AR-Wonders",
    demoStatus: "offline",
  },
];
